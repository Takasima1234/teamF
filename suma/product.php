...
?>
    <header class="header">
        <div class="header-logo">
            <img src="img/logo.png" alt="DeckLab Logo" class="logo-image">
        </div>
        <div class="header-icons">
            <a href="#"><img src="img/cart.png" alt="DeckLab Logo1" class="logo-image1"></a>
            <div class="user-menu">
              <p><a href="#">ログイン・登録</a></p>
              <p><a href="#">マイページ</a></p>
            </div>
        </div>
    </header>
    ...
    <main class="product-detail">
        ...
        <div class="product-image-container">
            <img src="img/zekrom_ex.jpg" alt="159/BW-P ゼクロムEXのカード画像" class="product-image">
        </div>
